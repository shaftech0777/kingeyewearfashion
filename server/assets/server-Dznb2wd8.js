...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-707ZNbt9.js");
...
const manifest = {
  "4a9e4e225d88c2cfb9e67c2effb2466038d3dfd47dfbf2d8325249baf2b2404c": {
    functionName: "askKingBot_createServerFn_handler",
    importer: () => import("./chatbot.functions-DlU3f3-8.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BNcUUPkN.js").then((n) => n.r),
    import("./start-DnBmdZ9v.js"),
